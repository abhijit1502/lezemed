                                ...
                                <div className="col-lg-12">
                                    <div className="th-blog">
                                        <div className="blog-content">
                                            ...
                                            <p className="mb-2">
                                                SRemit, its affiliates and subsidiaries place a priority on the Data Privacy of its employees, contractors, clients, prospective clients, service providers and other partners or third parties and on the importance of compliance with Data Protection and Privacy laws worldwide. Thus, SRemit has developed this Policy that outlines and explains the appropriate principles concerning collecting, processing, transferring and using an individual's Personal Data during everyday business.
                                            </p>
                                            <p>
                                                In its collection, use and disclosure of Personal Data, SRemit strives to balance the needs of managing its business effectively while minimising intrusiveness and complying with local legal requirements. In some countries, additional requirements beyond this policy may be applied to comply with local legislation. Data Protection and Privacy has been and will continue to be an integral component of SRemit business practices.
                                            </p>
                                        </div>
                                        ...
                                        <div className="blog-content">
                                            ...
                                            <ul className='info-number-list'>
                                                ...
                                                <li>
                                                    <span>F</span>
                                                    Business Need for Personal Data means those functions or duties requiring access to Personal Data that are necessary to carry out SRemit business functions, to comply with local applicable laws, or to administer its Human Resources functions. Such business needs include:
                                                </li>
                                            </ul>
                                        ...
                                        <div className="blog-content">
                                            ...
                                            <p className="mb-2">
                                                The Data Protection and Privacy principles below are the foundation of this Policy. As such, SRemit will, through appropriate management and controls on an ongoing basis, monitor implementation of and compliance with these principles. It shall be a fundamental principle with SRemit that any Personal Data shall be processed fairly, sensitively, respectfully and in accordance with this Policy and applicable local law.
                                            </p>
                                            <p className="mb-2">
                                                <strong>Notice:</strong> SRemit will inform individuals about the purpose for which it collects Personal Data, how to contact SRemit with inquiries or complaints, and the administrative process by which the complaints will be resolved. Where appropriate, SRemit will communicate the types of third parties to which SRemit discloses Personal Data, and the choices, procedures and means SRemit offers for limiting use and disclosure of personal information will also be provided.
                                            </p>
                                            <p className="mb-2">
                                                <strong>Choice:</strong> Subject to applicable local law and SRemit policies, general procedures and business requirements SRemit will ensure that the rights of Data Subjects, about whom Personal Data is held, can be fully exercised. This includes the right of an individual to choose how their Personal Data provided is used, whether the use of such data is incompatible with the original purpose or authorizations, or is disclosed to third parties, subject to laws requiring disclosure and consent.
                                            </p>
                                            <p className="mb-2">
                                                <strong>Onward Transfer:</strong> SRemit will ensure that all transfers of Personal Data, whether within or outside of the SRemit group, are protected by suitable safeguards and in accordance with applicable local law. Further, unless required by court or another legal mandate, or except as discussed below, Personal Data will only be transferred outside of SRemit if the receiving party has entered into a Data Protection Agreement with SRemit or comparable safeguards are in place. Where Personal Data is transferred outside of SRemit, SRemit will ensure that any such transfer protects the legitimate interests of Data Subjects in line with this Policy and applicable local law.
                                            </p>
                                            <p className="mb-2">
                                                <strong>Security:</strong> SRemit is committed to protecting Personal Data against unauthorized use or disclosure. To ensure the appropriate use of Personal Data, and prevent unauthorized access to such Personal Data, as well as prevent loss, alteration or destruction of Personal Data. In adherence with Data Protection and Privacy laws worldwide and internal SRemit policies, SRemit will address security at all appropriate technology infrastructure points.
                                            </p>
                                            <p className="mb-2">
                                                <strong>Data Integrity:</strong> SRemit will collect and process appropriate Personal Data only to the extent that there is a Business Need for Personal Data, to fulfill operational needs, and/or to comply with legal requirements, including those legal requirements of the countries in which the Personal Data was collected, as applicable. SRemit will take reasonable steps to ensure that all Personal Data is relevant, accurate, complete, current, and reliable for its intended use. All Data Subjects have a responsibility to assist SRemit in this effort.
                                            </p>
                                            <p className="mb-2">
                                                <strong>Data Retention:</strong> SRemit will not keep Personal Data for longer than is necessary for the purpose or purposes, for which it was intended, or as required by contractual agreement, by law or regulation, by other SRemit policies or, where applicable, for the appropriate statute of limitations period.
                                            </p>
                                            <p className="mb-2">
                                                <strong>Access:</strong> Upon request, SRemit will provide individuals with access to their Personal Data and, when appropriate, allow the individuals to request that their Personal Data be corrected or updated by SRemit, as required by law or SRemit policies.
                                            </p>
                                            <p className="mb-2">
                                                <strong>Enforcement and Oversight:</strong> SRemit will address complaints or disputes regarding Personal Data promptly, in an orderly fashion and courteously. SRemit will provide or, where appropriate, endeavor to provide notification to Data Subjects about how to file a complaint or inquiry and the administrative process to follow. SRemit will perform a self-assessment on a regular basis to verify that this Policy is communicated, prominently displayed, implemented, and accessible. SRemit will cooperate with the relevant Data Protection Authorities in the investigation and resolution of complaints relating to this Policy. SRemit will seek, in a timely manner as practicable, to comply in good faith with the advice of these authorities.
                                            </p>
                                            <p>
                                                <strong>Training and Audit:</strong> SRemit will provide appropriate training to all relevant staff handling and dealing with the Processing of Personal Data so that any such processing will be carried out in accordance with this Policy and applicable law. SRemit will further ensure that Data Protection and Privacy is subject to periodic audit.
                                            </p>
                                        </div>
                                        ...
                                        <div className="blog-content">
                                            ...
                                            <p>
                                                SRemit entities and all non- SRemit entities (e.g., agents, contractors, outsource service providers and processors) accessing or processing Personal Data are required to comply with this Policy with respect to such Personal Data.
                                            </p>
                                        </div>
                                        ...
                                        <div className="blog-content">
                                            ...
                                            <p>
                                                Data Subjects may review the contents of any files as requested pursuant to the access principles detailed above and subject to other SRemit policies. All Data Subjects must authenticate themselves based on online or offline standards (i.e., pass codes) set by SRemit before gaining access. Data Subject may request a copy of documents, but under no circumstances will an individual be allowed to remove any documents from the file or be allowed to remove the original file from SRemit. Certain confidential files, such as investigative files, will not be accessible to Data Subjects, in particular employees.
                                            </p>
                                        </div>
                                        ...
                                        <div className="blog-content">
                                            ...
                                            <p className="mb-2">
                                                Regarding any requests for information concerning an SRemit employee's status which may be received from non-SRemit entities, only members of the human resources department are authorized to release any information and this will be restricted to confirmation of current employment including the employee's name, the most recent job title and the dates of SRemit employment. Additional information will not be provided without the employee's authorization.
                                            </p>
                                            <p>
                                        ...
                                        <div className="blog-content">
                                            ...
                                            <p>
                                                SRemit may from time to time amend this Policy to reflect changes in any applicable legislation. SRemit will notify Data Subjects of such amendments as soon as reasonably practicable.
                                            </p>
                                        </div>
