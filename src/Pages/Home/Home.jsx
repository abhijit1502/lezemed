        ...
        <>
                    ...
                    <div className="about-feature-wrap">
                      ...
                      <div className="about-feature style3" style={{ maxWidth: '100%' }}>
                        ...
                        <div className="media-body">
                          ...
                          <p className="box-text">
                            SSRemit is super easy to use, backed up by outstanding Customer Support.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="overflow-hidden space pt-2" id="about-sec">
            <div className="container">
              ...
              <em>Choose the method that works best for you and enjoy seamless transfers with SSRemit!</em>
              </h6>
            </div>
          </div>
                ...
                <div className="col-xl-9">
                  <div className="choose-content">
                    <div className="mb-30">
                      ...
                      <h2 className="sec-title text-white">SSRemit ensures secure, reliable, and hassle-free money transfers you can trust.</h2>
                    </div>
